...
# Doing _GREAT_ analysis in R}

## Usage

_GREAT_ (http://great.stanford.edu) is a web-based tool to associate biological functions to genomic regions. 
The *rGREAT* package constructs a HTTP POST request according to user's input and automatically retrieves
results from _GREAT_ web server.
...
Available parameters are (following content is copied from _GREAT_ website):
