...
<p style='color:red'>Please note again, gene IDs in `gs` should be the same as in `et`.</p>
...
**rGREAT** now supports 556 organisms. The complete list can be found at https://jokergoo.github.io/rGREAT_genesets/. Just make sure the genome version 
