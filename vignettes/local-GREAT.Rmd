...
- Name of an `org.*` package, e.g. `org.Hs.eg.db`. Supported packages are in `rGREAT:::BIOC_ANNO_PKGS$orgdb`.
...
**rGREAT** now supports 562 organisms. The complete list can be found at https://jokergoo.github.io/rGREAT_genesets/.
